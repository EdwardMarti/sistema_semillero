...
function iniciarTabla() {
    ...
    $("#listadoOrdenesTabla").DataTable({
        ...
        lengthChange: false,
        language: {
            emptyTable: "No hay proyectos en ejecucion para mostrar...",
            search: "Buscar:",
 ...
 */
function mostrarModalProyectos_e() {
//    limpiarcampos();
    $('#myModalProyectos_e').modal({show: true});
    $("#btnOrderReg").show();
    $("#btnOrderAct").hide();
}

function cerrarModalProyectos_e() {
        $('#myModalProyectos_e').modal('hide');
}
