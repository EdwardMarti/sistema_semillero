...
function UpdateEstu() {
    ...
    fetch("../../back/controller/SemilleroController_UpdateEstu.php", {
        ...
        .then(function(data) {
            $('#listadoEstudiantesTabla2').DataTable().row(estu_index).data(update_estu).draw();
            cerrarModalEstu();
            Mensaje.mostrarMsjExito("Registro Exitoso", data.mensaje);
        })
        .catch(function(promise) {
...
function eliminarEstu(id, index, persona_id_id) {
    ...
    fetch("../../back/controller/EstudianteController_DeleteEstu.php", {
        ...
        .then(function(data) {
            $("#listadoEstudiantesTabla2").DataTable().row(index).remove().draw();
            Mensaje.mostrarMsjExito("Registro Exitoso", data.mensaje);
...
function iniciarTablaDatosAdicionales() {
    ...
    $("#listadoTablaDatosAdicionales").DataTable({
        ...
        lengthChange: false,
        language: {
            emptyTable: "Sin Datos Adicionales...",
            search: "Buscar:",
            info: "_START_ de _MAX_ registros", //_END_ muestra donde acaba _TOTAL_ muestra el total
            infoEmpty: "Ningun registro 0 de 0",
            infoFiltered: "(filtro de _MAX_ registros en total)",
