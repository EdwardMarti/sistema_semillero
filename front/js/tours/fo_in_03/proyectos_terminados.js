$(document).ready(function() {
    ...
    var tour = new Tour({
        ...
        steps: [{
            ...
            {
                element: "#collapseTwo",
                title: "Cooinvestigadores",
                content: "En esta seccion podras ver los cooinvestigadores relacionados al proyecto ademas de poder <strong>agregar</strong> o <strong>eliminar</strong> cuando lo requieras.",
                placement: "top",
                backdrop: true,
                onHide: () => {
                    $("#collapseTwo").toggle();
