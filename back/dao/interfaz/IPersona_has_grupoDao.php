...
interface IPersona_has_grupoDao {
  ...
  public function select($persona_has_grupo);
    /**
     * Lista todos los objetos Persona_has_grupo en la base de datos.
     * @return Array<Persona_has_grupo> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
