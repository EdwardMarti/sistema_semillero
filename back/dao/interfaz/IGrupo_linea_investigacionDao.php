...
interface IGrupo_linea_investigacionDao {
  ...
  public function select($grupo_linea_investigacion);
    /**
     * Lista todos los objetos Grupo_linea_investigacion en la base de datos.
     * @return Array<Grupo_linea_investigacion> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
